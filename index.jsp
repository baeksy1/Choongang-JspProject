                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"><!-- data-ride="carousel" 자동 슬라이드 기능 -->
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                               	<a href="lookfor/lookfor_content.lookfor?num=14"> <img class="img-responsive img-full" src="img/1.jpg" ></a>
                            </div>
                            <div class="item">
                                <a href="lookfor/lookfor_content.lookfor?num=17"><img class="img-responsive img-full" src="img/2.jpg"></a> <!-- img-full 옵션 class -->
                            </div>
                            <div class="item">
                              	<a href="lookfor/lookfor_content.lookfor?num=19">  <img class="img-responsive img-full" src="img/3.jpg"></a>
                            </div>
